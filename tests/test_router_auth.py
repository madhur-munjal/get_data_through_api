...
# from get_data_through_api.src.database import get_db
# from get_data_through_api.src.main import app  # or wherever your FastAPI app is defined
# from get_data_through_api.src.schemas.tables.users import User
# from get_data_through_api.src.models.users import UserLogin
# from get_data_through_api.src.auth_utils import verify_password, create_access_token
#
...
#
#         payload = {"username": "testuser", "password": "hashedpassword"}
#
